...
<body class="bg-light">
    ...
    <div class="py-3  shadow-sm">
        <div class="container d-flex justify-content-between">
            ...
            <div class="nav-item dropstart">
                ...
                <a class="nav-link img-profil ms-0" style="background-image: url('../img/user/<?php echo $af['foto'] ?>') ;" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                </a>
                <?php
                ?>
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item bg-white link-secondary" href="logout.php"><i class="bx bx-log-out"></i>
                            Logout</a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="offcanvas offcanvas-start" style="width: 300px;" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title text-warning" id="offcanvasExampleLabel">Lingkungan Pule</h5>
        ...
        <div class="offcanvas-body">
            <ul class="nav flex-column">
                ...
                <br>
                <h6 class="text-secondary ps-3">Isi data</h6>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link link-secondary <?php if ($page == 'event') {
                                                            echo "active";
                                                        } ?>" href="?page=event">
                        <i class="bx bx-book-open me-2"></i>
                        Event
