...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <p data-aos="fade-up"><?php echo $data['tanggal']; ?><span class="ms-5">By :
                    <?php echo $data['username']; ?></span></p>
            ...
            <form action="" method="post" class="mt-5">
                <div class="input-group mb-3">
                    ...
                    <button class="input-group-text btn btn-warning py-2 text-light" name="kirimKomentar"><i
                    ...
                    <div class="d-flex mt-3">
                        <div class="me-3">
                            ...
                            <div class="img-komentar"
                                style="background-image: url('img/user/<?php echo $komentar['foto'] ?>');"></div>
                            <?php } else { ?>
                            <div class="img-komentar"
